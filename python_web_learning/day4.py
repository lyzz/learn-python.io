...
# 登陆成功后点击 订单管理--订单管理
# dingdanguanli = driver.find_element_by_css_selector('ul.site-sidebar__menu.el-menu>li:nth-child(5)')

# dingdanguanli.click()

# dingdanguanli_child = driver.find_element_by_css_selector('li.el-submenu.is-opened>ul.el-menu.el-menu--inline>'
#                                                           'li:nth-child(1)')
# dingdanguanli_child.click()

# #  找到第一个订单编号，并打印出来值
# order = driver.find_element_by_css_selector('div.content>div.prod:nth-child(2)>div.prod-tit:nth-child(1)'
#                                             '>span:nth-child(1)')
